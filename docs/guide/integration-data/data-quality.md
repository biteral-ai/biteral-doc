...
- :icon-check-circle: **`Zoom`** `Óptico 10x, digital 100x`
- :icon-check-circle: **`Vídeo`** `Full HD 1080p a 60 fps`
- :icon-check-circle: **`Sensor`** `CMOS APS-C de 24.2 MP`
...
- :icon-check-circle: **`Tamaño`** `Queen size, 150x190cm`
- :icon-check-circle: **`Material`** `Capa viscoelástica de 4cm, espuma HR 30 kg/m³, con tratamiento antibacteriano`
...
- :icon-circle-slash: **`Aroma`** `Cítrico`
...
- :icon-check-circle: **`Aroma`** `Cítrico fresco con notas de lima y mandarina`
- :icon-check-circle: **`Tipo de piel`** `Apto para todo tipo de piel, incluso sensible`
- :icon-check-circle: **`Envase`** `500 ml, botella reciclable con dosificador`
